...
# one
png(paste0(savepath, "cell_v1.png"))
blank_plot()
...
# two
png(paste0(savepath, "cell_v2.png"))
blank_plot()
...
# three
png(paste0(savepath, "cell_v3.png"))
blank_plot()
...
# four
png(paste0(savepath, "cell_v4.png"))
blank_plot()
plot_cell(sm_sq_x, sm_sq_y, cellgreen)
plot_cell(sm_sq_x, sm_sq_y+0.5, cellgreen)
...
# five
png(paste0(savepath, "cell_v5.png"))
blank_plot()
...
# six 
png(paste0(savepath, "cell_v6.png"))
blank_plot()
...
# seven 
png(paste0(savepath, "cell_v7.png"))
blank_plot()
...
# eight
png(paste0(savepath, "cell_v8.png"))
blank_plot()
