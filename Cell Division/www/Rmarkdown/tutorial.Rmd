...
output: 
  ioslides_presentation:
    widescreen: false
    logo: cells/cell_logo.png
    css: tutorial_style.css
---



## <img src="cells/cell_v1.png" class="cell"/> Intro
...
```
## <img src="cells/cell_v2.png" class="cell" "/> Placing Your Cell
...
## <img src="cells/cell_v2.png" class="cell" "/> Placing Your Cells
...
## <img src="cells/cell_v3.png" class="cell" "/> Placing Your Cells
In the beaker and flask layout, cells fall to the bottommost row.
```{r, out.width = "100%", echo=FALSE}
plot_img(file.path("layouts", "beaker2.png"))
```

## <img src="cells/cell_v3.png" class="cell" "/> Scoring System
...
## <img src="cells/cell_v4.png" class="cell" "/> And the Winner is...
...
## <img src="cells/cell_v8.png" class="cell" "/> Thanks for Playing!!!
